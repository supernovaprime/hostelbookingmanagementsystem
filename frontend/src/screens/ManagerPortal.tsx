...
const ManagerPortal = ({ navigation }: { navigation: ManagerPortalNavigationProp }) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.subtitle}>Manage your hostels and bookings</Text>

      <TouchableOpacity style={styles.button}>
        <Text style={styles.buttonText}>My Hostels</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.button, styles.secondaryButton]}>
        <Text style={[styles.buttonText, styles.secondaryButtonText]}>Manage Rooms</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={[styles.button, styles.tertiaryButton]}>
        <Text style={[styles.buttonText, styles.tertiaryButtonText]}>Maintenance Requests</Text>
      </TouchableOpacity>
